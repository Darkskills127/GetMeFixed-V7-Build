...
rem --------------------------------------------------------------------------
rem Start Kombustor and log GPU data.
rem MSI-Kombustor-x64.exe -log_gpu_data -append_date_to_gpu_log_file -nogui -width=1920 -height=1080 -glfurrymsi
rem --------------------------------------------------------------------------

rem --------------------------------------------------------------------------
rem Start Kombustor and reads GPU sensors via MSI Afterburner (-do_ab_monitoring).
MSI-Kombustor-x64.exe -do_ab_monitoring -nogui -width=1920 -height=1080 -glmsi01
rem --------------------------------------------------------------------------
